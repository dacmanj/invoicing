...
(function() {
  jQuery(function($) {
    return $(document).ready(function() {
      var append_template, id, t, tmpl, use_template, _i, _len;
      append_template = function(id, t) {
        $("#template").append("<option value=" + id + ">" + t.name + "</option>");
        return console.log(t);
      };
      use_template = function(t) {
        var id;
        id = $("select#template").val();
        tinymce.get('message').setContent(templates[id].message);
        return $("#subject").val(templates[id].subject);
      };
      if (typeof templates !== "undefined" && templates !== null) {
        ...
        return $(".send_invoice_email").delegate("select#template", "change", use_template);
      }
    });
  });
  ...
  jQuery(function($) {
    return $(document).ready(function() {
      ...
      if ($('.duplicatable_nested_form').length) {
        ...
        $('form').delegate('.destroy_duplicate_nested_form', 'click', function(e) {
