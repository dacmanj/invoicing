  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved code as @code" do
        ...
        post :create, {:code => { "category" => "invalid value" }}, valid_session
        assigns(:code).should be_a_new(Code)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested code" do
        ...
        Code.any_instance.should_receive(:update_attributes).with({ "category" => "MyString" })
        put :update, {:id => code.to_param, :code => { "category" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the code as @code" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Code.any_instance.stub(:save).and_return(false)
        put :update, {:id => code.to_param, :code => { "category" => "invalid value" }}, valid_session
        assigns(:code).should eq(code)
      end
